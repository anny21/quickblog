...
<head>
    ...
    <link rel="stylesheet" href="{{asset('quickblog/assets/custom.css')}}">
</head>
<body>
...
<form action="{{route('create-post')}}" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
      ...
      <input type="text" value="{{old('title', $post->title)}}" name="title" class="form-control" id="title" aria-describedby="titleHelp" placeholder="Enter Blog Title">
   ...
   <input type="checkbox" id="{{$category->slug}}" @if(in_array($category->name, json_decode($post->category))) checked @endif name="categories[]" value="{{$category->slug}}">
