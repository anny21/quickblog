...
<form action="{{route('create-post')}}" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
      ...
      <input type="text" value="{{old('title')}}" name="title" class="form-control" id="title" aria-describedby="titleHelp" placeholder="Enter Blog Title">
    ...
    <button type="submit" class="btn btn-primary">Submit</button>
        ...
        <div class="col-md-4 right-panel">
            ...
            <input type="checkbox" id="{{$category->slug}}" name="categories[]" value="{{$category->name}}">
