				...
				<div class="row justify-content-between">
					<div class="col-md-6 pt-6 pb-6 pr-6 align-self-center">
						...
						<div class="d-flex align-items-center">
							...
							<small class="ml-2">Admin <span class="text-muted d-block">{{$post->created_at}} &middot; 5
									min. read</span>
							</small>
						</div>
					</div>
					<div class="col-md-6 pr-0">
						<img style="width:100%; height:100%"
							src="@if($post->banner) {{ asset('storage/postBanners/' . $post->banner)}} @else {{asset('quickblog/assets/images.jpg')}} @endif">
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-lg-6">
				<div class="card border-0 mb-4 box-shadow h-xl-300">
					<div
						style="background-image: url(@if($post->nextPost() && $post->nextPost()['banner']) {{ asset('storage/postBanners/' . $post->nextPost()['banner'])}} @elseif($post->nextPost() && $post->nextPost()['banner'] == null) {{asset('quickblog/assets/images.jpg')}} @endif); height: 150px; background-size: cover; background-repeat: no-repeat;">
					</div>
					<div class="card-body px-0 pb-0 d-flex flex-column align-items-start">
						...
						<div>
							<small class="d-block"><a class="text-muted" href="./author.html">@if($post->nextPost())
									Admin @endif </a></small>
